...
import { FiSearch, FiEdit2, FiTrash2, FiBookOpen } from "react-icons/fi";
                ...
                <tr key={book.id}>
                  ...
                  <td>
                    <div className="action-btns">
                      <button className="btn-icon edit" onClick={() => handleEdit(book)} title="Edit"><FiEdit2 /></button>
                      <button className="btn-icon del" onClick={() => setDeleteId(book.id)} title="Hapus"><FiTrash2 /></button>
                    </div>
                  </td>
                </tr>
              ))
